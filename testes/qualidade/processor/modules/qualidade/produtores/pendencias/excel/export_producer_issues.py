...
OPERATION = "qualidade.exportar_produtor_pendencias"
CURRENT_DIR = Path(__file__).resolve().parent
GENERAL_EXPORTER = CURRENT_DIR.parents[2] / "relatorios" / "fora_padrao" / "geral" / "excel"
...
def export_file(input_path: Path, output_path: Path, logo_path: Path | None) -> dict[str, Any]:
    try:
        ...
        return {
            ...
            "errors": [{
                "code": "EXPORT_850",
                "message": "Falha ao exportar inconsistências do produtor.",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Exporta inconsistências de um produtor para XLSX.")
