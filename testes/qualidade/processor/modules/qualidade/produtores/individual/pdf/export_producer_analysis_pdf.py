...
OPERATION = "qualidade.exportar_produtor_analises_pdf"
CURRENT_DIR = Path(__file__).resolve().parent
GENERAL_EXPORTER = CURRENT_DIR.parents[1] / "pdf"
sys.path.insert(0, str(GENERAL_EXPORTER))

from export_producer_analyses_pdf import build_pdf  # noqa: E402
...
def export_file(input_path: Path, output_path: Path, logo_path: Path | None) -> dict[str, Any]:
    try:
        ...
        return {
            ...
            "errors": [{
                "code": "EXPORT_840",
                "message": "Falha ao exportar PDF de analises do produtor.",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Exporta analises de um produtor para PDF.")
