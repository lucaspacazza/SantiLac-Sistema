...
class ProducaoCremeService extends BaseFormularioService
{
    ...
    {
        return $this->paginarFormulario($request, ProducaoCreme::class, ['tipo_creme', 'lote_creme_produzido', 'responsavel'], 'data_fabricacao', fn (ProducaoCreme $item): array => $this->formatar($item));
    }
    ...
    public function formatar(ProducaoCreme $item): array
    {
        return [
            'id' => (int) $item->id,
