...
class FormulacaoCremeService extends BaseFormularioService
{
    ...
    {
        return $this->paginarFormulario($request, ProducaoFormulacaoCreme::class, ['tipo_creme', 'lote_creme_produzido', 'responsavel'], 'data_fabricacao', fn (ProducaoFormulacaoCreme $item): array => $this->formatar($item));
    }
    ...
    public function formatar(ProducaoFormulacaoCreme $item): array
    {
        return [
            'id' => (int) $item->id,
